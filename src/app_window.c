...
#define WAVE_COLOR_R 0.165
#define WAVE_COLOR_G 0.655
#define WAVE_COLOR_B 0.259
...
#define COLOR_CONNECTED_R 0.165
...
MainWindow *app_window_create(AppConfig *config, AppStateController *controller,
    ...
    if (gear_pixbuf) {
        /* Scale the gear icon to fit status bar */
        int dest_size = 24;
